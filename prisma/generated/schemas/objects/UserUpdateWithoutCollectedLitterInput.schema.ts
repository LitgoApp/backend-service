...
import { LitterSiteUpdateManyWithoutReporterUserNestedInputObjectSchema } from '../internals'

export const UserUpdateWithoutCollectedLitterInputObjectSchema = Yup.object({
