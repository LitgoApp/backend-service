...
const Schema: z.ZodType<Prisma.LitterSiteCreateNestedManyWithoutCollectorUserInput> =
  z
    .object({
      create: z
        .union([
...
export const LitterSiteCreateNestedManyWithoutCollectorUserInputObjectSchema =
  Schema;
