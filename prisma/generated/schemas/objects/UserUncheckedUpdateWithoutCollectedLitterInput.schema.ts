...
import { LitterSiteUncheckedUpdateManyWithoutReporterUserNestedInputObjectSchema } from '../internals'

export const UserUncheckedUpdateWithoutCollectedLitterInputObjectSchema =
  Yup.object({
