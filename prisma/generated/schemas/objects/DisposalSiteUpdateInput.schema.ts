...
import { MunicipalityUpdateOneRequiredWithoutDisposalSitesNestedInputObjectSchema } from '../internals'

export const DisposalSiteUpdateInputObjectSchema = Yup.object({
