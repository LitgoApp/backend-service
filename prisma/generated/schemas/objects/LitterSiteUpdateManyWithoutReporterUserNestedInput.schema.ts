...
const Schema: z.ZodType<Prisma.LitterSiteUpdateManyWithoutReporterUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LitterSiteUpdateManyWithoutReporterUserNestedInputObjectSchema =
  Schema;
