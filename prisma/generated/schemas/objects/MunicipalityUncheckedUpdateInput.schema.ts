...
import { RegionUncheckedUpdateManyWithoutMunicipalityNestedInputObjectSchema } from '../internals'
import { DisposalSiteUncheckedUpdateManyWithoutMunicipalityNestedInputObjectSchema } from '../internals'

export const MunicipalityUncheckedUpdateInputObjectSchema = Yup.object({
  ...
  regions: RegionUncheckedUpdateManyWithoutMunicipalityNestedInputObjectSchema,
  disposalSites:
