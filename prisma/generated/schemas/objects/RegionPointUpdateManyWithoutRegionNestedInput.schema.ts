...
const Schema: z.ZodType<Prisma.RegionPointUpdateManyWithoutRegionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RegionPointUpdateManyWithoutRegionNestedInputObjectSchema = Schema;
